...
const solucionesIcons: FloatingIconsHeroProps["icons"] = [
  { id: 1, icon: IconGoogle, className: "top-[12%] left-[10%]" },
  { id: 2, icon: IconMicrosoft, className: "top-[15%] right-[10%]" },
  { id: 3, icon: IconSlack, className: "top-[8%] left-[38%]" },
  { id: 4, icon: IconVercel, className: "top-[10%] right-[35%]" },
  { id: 5, icon: IconYouTube, className: "top-[50%] left-[6%]" },
  { id: 6, icon: IconNotion, className: "top-[48%] right-[6%]" },
  { id: 7, icon: IconGitHub, className: "bottom-[15%] left-[12%]" },
  { id: 8, icon: IconFigma, className: "bottom-[12%] right-[12%]" },
  { id: 9, icon: IconStripe, className: "bottom-[8%] left-[40%]" },
  { id: 10, icon: IconTwitch, className: "bottom-[10%] right-[38%]" },
];

const SolucionesSection = () => {
  return (
    <section className="bg-gradient-to-br from-teal-100 via-cyan-50 to-slate-200 dark:from-slate-900 dark:via-teal-950/40 dark:to-slate-900">
      <FloatingIconsHero
        title="Soluciones Digitales"
        subtitle="Nuestro ecosistema de soluciones digitales para tu marca"
        icons={solucionesIcons}
      />
    </section>
  );
};

...
export function Component({
  ...
  const draw = useCallback(() => {
    ...
    for (let i = 0; i < dots.length; i++) {
      ...
      const hue = 170 + depthAlpha * 20;
      ctx.fillStyle = `hsla(${hue}, 80%, 50%, ${depthAlpha.toFixed(2)})`;
      ctx.fill();
    }
  ...
  return (
    <canvas
      ...
      style={{ width: size, height: size, maxWidth: "100%", touchAction: "none", cursor: "grab" }}
